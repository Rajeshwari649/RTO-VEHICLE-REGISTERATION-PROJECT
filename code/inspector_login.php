				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
                                ...
                                <h2 style = "margin-left:1200px;"><a href="home.html" style="text-decoration:none;color:white;"><span data-hover="HOME">HOME</span></a></h2>
							</div>
						</div>
					</div>
				</nav>
				...
				<div class="container">
					<div class="footer-grids">
						<div class="col-md-8 footer-grid">
							<h4>About Us</h4>
							<p>  Organisation of the Indian government responsible for maintaining a database of drivers and a database of vehicles for TamilNadu.<span>
                  ...
                  It also is responsible to inspect vehicle's insurance and clear the pollution test.</span></p>
						...
						<h4>Information</h4>
							<ul>
								...
								<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:tamilnadu@rto.com"> tamilnadu@rto.com</a></li>
